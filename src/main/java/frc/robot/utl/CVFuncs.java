...
public class CVFuncs {
	...
	public static Mat[] estimatePose() {
        ...
        // sets a Mat to Limelight's intrinsic parameters (focal length and optical center)
        ...
        MatOfDouble distCoeffs = new MatOfDouble(2.9684613693070039e-01, 
            -1.4380252254747885e+00, -2.2098421479494509e-03, 
