...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    double DRIVETRAIN_WHEEL_DIAMETER = 6.0;
    int DRIVETRAIN_ENCODERS_PULSES_PER_REVOLUTION = 256;
    int DRIVETRAIN_ENCODERS_FACTOR = 4;
    double DRIVETRAIN_ENCODERS_INCHES_PER_REVOLUTION = Math.PI * DRIVETRAIN_WHEEL_DIAMETER;

    double DRIVETRAIN_INCHES_EMPERICAL_RAW_MULTIPLIER = (63.7 / 63.0) * 61.1 / ((463.544 + 461.814) / 2.0);
    
    double DRIVETRAIN_INCHES_RAW_MULTIPLIER = 
